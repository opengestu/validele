-- Migration pour permettre aux livreurs de voir les profils vendeurs
-- Nécessaire pour pouvoir payer les vendeurs après livraison
...
-- 3. Les profils des vendeurs des commandes qu'ils livrent
CREATE POLICY "Delivery persons can view customer and vendor profiles" 
ON public.profiles FOR SELECT 
USING (
  -- Les utilisateurs peuvent voir leur propre profil
  (auth.uid() = id) OR
  -- Les livreurs peuvent voir les profils des clients ET vendeurs pour la livraison
  (EXISTS (
